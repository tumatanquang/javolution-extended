...
public class FastMap/*<K,V>*/ implements Map/*<K,V>*/, Reusable, XMLSerializable, Realtime {
	...
	public final Object/*{V}*/ put(Object/*{K}*/ key, Object/*{V}*/ value) {
		return (Object/*{V}*/) put(key, value, _isDirectKeyComparator ? key.hashCode() : _keyComparator.hashCodeOf(key),
			...
			public void run() {
				...
				if(nullCount > _entryCount) { // Yes.
					if(isShared) { // Replaces with a new table.
						...
						final Object[] tmp = (Object[]) ArrayFactory.OBJECTS_FACTORY.array(_entries.length);
				...
				for(int i = 0; i < _entries.length;) {
					...
					final FastMap subMap = _subMaps[entry._keyHash >> _keyShift & C2 - 1];
	...
	public final Entry/*<K,V>*/ putEntry(Object/*{K}*/ key, Object/*{V}*/ value) {
		return (Entry/*<K,V>*/) put(key, value,
				_isDirectKeyComparator ? key.hashCode() : _keyComparator.hashCodeOf(key), _isShared, false, true);
	}
	/**
	 ...
	 * @throws NullPointerException if the key is <code>null</code>.
	 */
	public final Object/*{V}*/ putIfAbsent(Object/*{K}*/ key, Object/*{V}*/ value) {
		return (Object/*{V}*/) put(key, value, _isDirectKeyComparator ? key.hashCode() : _keyComparator.hashCodeOf(key),
	...
	public final Object/*{V}*/ remove(Object key) {
		return (Object/*{V}*/) remove(key, _isDirectKeyComparator ? key.hashCode() : _keyComparator.hashCodeOf(key),
				_isShared);
	}
	...
	public FastMap/*<K,V>*/ setKeyComparator(FastComparator/*<? super K>*/ keyComparator) {
		...
		_isDirectKeyComparator = keyComparator == FastComparator.DIRECT || _keyComparator == FastComparator.DEFAULT
				&& !((Boolean) FastComparator.REHASH_SYSTEM_HASHCODE.get()).booleanValue();
		return this;
	}
	/**
	...
	private static final class ValueIterator implements Iterator {
		...
		public static ValueIterator valueOf(FastMap map) {
			final ValueIterator iterator = (ValueIterator) ValueIterator.FACTORY.object();
			iterator._map = map;
	...
	private static final class EntryIterator implements Iterator {
		...
		public static EntryIterator valueOf(FastMap map) {
			final EntryIterator iterator = (EntryIterator) EntryIterator.FACTORY.object();
			iterator._map = map;
			iterator._next = map._head._next;
			iterator._tail = map._tail;
			return iterator;
	...
	private static final class KeyIterator implements Iterator {
		...
		public static KeyIterator valueOf(FastMap map) {
			final KeyIterator iterator = (KeyIterator) KeyIterator.FACTORY.object();
			iterator._map = map;
			iterator._next = map._head._next;
			iterator._tail = map._tail;
			return iterator;
