...
import _templates.javolution.util.internal.collection.SharedFastList;
import _templates.javolution.util.internal.collection.UnmodifiableFastList;
/**
 ...
 */
public class FastList/*<E>*/ extends AbstractList/*<E>*/ implements List/*<E>*/, Reusable {
	/**
	...
	*/
	...
	public boolean addAll(int index, Collection/*<? extends E>*/ values) {
		...
		for(final Iterator /*<? extends E>*/ i = values.iterator(); i.hasNext();) {
	...
	public FastCollection/*FastList<E>*/ unmodifiable() {
		return new UnmodifiableFastList/*<E>*/(this);
	}
	// Overrides to return a list (JDK1.5+).
	public FastCollection/*FastList<E>*/ shared() {
		return new SharedFastList/*<E>*/(this);
	}
	/**
