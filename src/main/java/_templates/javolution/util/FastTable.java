 ...
 */
public class FastTable/*<E>*/ extends FastAbstractList/*<E>*/ implements List/*<E>*/, Reusable, RandomAccess {
	/**
	...
	public FastCollection/*FastTable<E>*/ unmodifiable() {
		return new FastTable/*<E>*/(super.unmodifiable(), _rejectNulls);
	}
	// Overrides to return a list (JDK1.5+).
	public FastCollection/*FastTable<E>*/ shared() {
		return new FastTable/*<E>*/(super.shared(), _rejectNulls);
	}
