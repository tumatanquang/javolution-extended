...
public class ConcurrentReaderHashMap extends AbstractMap implements Map, Cloneable, Serializable {
	...
	final boolean sreplace(Object key, Object oldValue, Object newValue, int hash) {
		final Entry[] tab = table;
		final int index = hash & tab.length - 1;
	...
	public static KeySetView newKeySet(int initialCapacity) {
		return new KeySetView(new ConcurrentReaderHashMap(initialCapacity), Boolean.TRUE);
	}
	/**
