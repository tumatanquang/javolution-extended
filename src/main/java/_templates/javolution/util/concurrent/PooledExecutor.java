...
public class PooledExecutor extends ThreadFactoryUser implements Executor {
	 ...
	 */
	private static final class RunWhenBlocked implements BlockedExecutionHandler {
	 ...
	 */
	private static final class DiscardWhenBlocked implements BlockedExecutionHandler {
		public boolean blockedAction(Runnable command) {
			return true;
		}
	}
	 ...
	 */
	private static final class AbortWhenBlocked implements BlockedExecutionHandler {
		public boolean blockedAction(Runnable command) {
	 ...
	 */
	private final class DiscardOldestWhenBlocked implements BlockedExecutionHandler {
		public boolean blockedAction(Runnable command) throws InterruptedException {
			_handOff.poll(0);
