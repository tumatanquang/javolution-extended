 ...
 */
public class FastBooleanArrayList extends FastPrimitiveList
	...
	public FastPrimitiveList/*FastBooleanArrayList*/ unmodifiable() {
		return new Unmodifiable(this);
	}
	public FastPrimitiveList/*FastBooleanArrayList*/ shared() {
		return new Shared(this);
	}
	/**
	 * Returns an iterator over the <code>boolean</code> elements in this list.
	 *
	...
	/**
	 * Returns the <em>removed value</em>, <strong>not</strong> a success flag.
	 */
	...
	/**
	 * An unmodifiable view over a {@code FastBooleanArrayList}.
	 */
	private static final class Unmodifiable extends FastBooleanArrayList
			implements Cloneable, RandomAccess, Reusable, Serializable {
		private final FastBooleanArrayList _list;
		private Unmodifiable(FastBooleanArrayList list) {
			super(0);
			_list = list;
		}
		public final FastPrimitiveList/*FastBooleanArrayList*/ unmodifiable() {
			return this;
		}
		public final FastPrimitiveList/*FastBooleanArrayList*/ shared() {
		...
		public final Object/*FastBooleanArrayList*/ clone()
				throws CloneNotSupportedException {
			return _list.clone();
		}
		...
		public final boolean addAll(FastBooleanArrayList values) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		public final boolean addAll(int index, FastBooleanArrayList values) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		...
		public final FastPrimitiveIterator/*FastBooleanIterator*/ iterator() {
			return new FastBooleanIterator() {
				private final FastBooleanIterator _it = (FastBooleanIterator) _list
						.iterator();
	...
	/**
	 * A shared view over a {@code FastBooleanArrayList} (reads-write locks).
	 */
	private static final class Shared extends FastBooleanArrayList
			implements Cloneable, RandomAccess, Reusable, Serializable {
		private final FastBooleanArrayList _list;
		private final ReadWriteLock _lock;
		private Shared(FastBooleanArrayList list) {
			super(0);
			_list = list;
	...
	/**
	 * An iterator over a {@code FastBooleanArrayList}.
	 */
	private static final class BooleanIterator implements FastBooleanIterator {
		private final FastBooleanArrayList _list;
		private int _cursor;
		private int _lastRet = -1;
		private BooleanIterator(FastBooleanArrayList list) {
			_list = list;
		}
		public boolean hasNext() {
			return _cursor < _list.size();
