 ...
 */
public class FastShortArrayList extends FastPrimitiveList
	...
	public FastPrimitiveList/*FastShortArrayList*/ unmodifiable() {
		return new Unmodifiable(this);
	}
	public FastPrimitiveList/*FastShortArrayList*/ shared() {
		return new Shared(this);
	}
	/**
	 * Returns an iterator over the <code>short</code> elements in this list.
	 *
	...
	/**
	 * An unmodifiable view over a {@code FastShortArrayList}.
	 */
	private static final class Unmodifiable extends FastShortArrayList
			implements Cloneable, RandomAccess, Reusable, Serializable {
		private final FastShortArrayList _list;
		private Unmodifiable(FastShortArrayList list) {
			super(0);
			_list = list;
		}
		public final FastPrimitiveList/*FastShortArrayList*/ unmodifiable() {
			return this;
		}
		public final FastPrimitiveList/*FastShortArrayList*/ shared() {
		...
		public final Object/*FastShortArrayList*/ clone()
				throws CloneNotSupportedException {
			return _list.clone();
		}
		...
		public final boolean addAll(FastShortArrayList values) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		public final boolean addAll(int index, FastShortArrayList values) {
			throw new UnsupportedOperationException("Unmodifiable");
		}
		...
		public final FastPrimitiveIterator/*FastShortIterator*/ iterator() {
			return new FastShortIterator() {
				private final FastShortIterator _it = (FastShortIterator) _list
						.iterator();
	...
	/**
	 * A shared view over a {@code FastShortArrayList} (reads-write locks).
	 */
	private static final class Shared extends FastShortArrayList
			implements Cloneable, RandomAccess, Reusable, Serializable {
		private final FastShortArrayList _list;
		private final ReadWriteLock _lock;
		private Shared(FastShortArrayList list) {
			super(0);
			_list = list;
	...
	/**
	 * An iterator over a {@code FastShortArrayList}.
	 */
	private static final class ShortIterator implements FastShortIterator {
		private final FastShortArrayList _list;
		private int _cursor;
		private int _lastRet = -1;
		private ShortIterator(FastShortArrayList list) {
			_list = list;
		}
		public boolean hasNext() {
			return _cursor < _list.size();
