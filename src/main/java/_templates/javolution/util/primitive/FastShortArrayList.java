 ...
 * @since 5.7.1
 */
public class FastShortArrayList implements Cloneable, RandomAccess, Serializable {
	...
	public Object/*FastShortArrayList*/ clone() throws CloneNotSupportedException {
		/*@JVM-1.1+@
		if(true) {
