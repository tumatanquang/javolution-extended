...
public final class SAX2ReaderImpl implements XMLReader, Reusable {
	 ...
	 */
	private static final class Proxy implements _templates.javolution.xml.sax.ContentHandler, Attributes {
		/**
		...
		public String getURI(int index) {
			final CharSequence chars = _attributes != null ? _attributes.getURI(index) : null;
			return chars != null ? chars.toString() : "";
		}
		// Implements Attributes
		public String getLocalName(int index) {
			final CharSequence chars = _attributes != null ? _attributes.getLocalName(index) : null;
			return chars != null ? chars.toString() : "";
		}
		// Implements Attributes
		public String getQName(int index) {
			final CharSequence chars = _attributes != null ? _attributes.getQName(index) : null;
			return chars != null ? chars.toString() : "";
		}
		// Implements Attributes
		...
		public String getValue(int index) {
			final CharSequence chars = _attributes != null ? _attributes.getValue(index) : null;
