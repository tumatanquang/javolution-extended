...
public class XMLBinding implements Reusable, XMLSerializable {
	...
	static final XMLFormat OBJECT_XML = new XMLFormat(Object.class) {
		...
		public Object newInstance(Class cls, _templates.javolution.xml.XMLFormat.InputElement xml)
				throws XMLStreamException {
	 ...
	 * default constructor.
	 */
	static final XMLFormat COLLECTION_XML = new XMLFormat(_templates.java.util.Collection.class) {
		public void read(InputElement xml, Object obj) throws XMLStreamException {
