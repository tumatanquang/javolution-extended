...
public abstract class XMLFormat/*<T>*/ {
	...
	public static /*<T>*/ XMLFormat/*<T>*/ getInstance(Class/*<? extends T>*/ forClass) {
		...
		final XMLFormat xmlFormat = (XMLFormat) Reflection.getInstance().getField(forClass, XMLFormat.class, true);
	 ...
	 */
	public Object/*{T}*/ newInstance(Class/*<T>*/ cls, InputElement xml) throws XMLStreamException {
		try {
	 ...
	 */
	public abstract void write(Object/*{T}*/ obj, OutputElement xml) throws XMLStreamException;
	/**
	 ...
	 */
	public abstract void read(InputElement xml, Object/*{T}*/ obj) throws XMLStreamException;
	/**
	...
	public static final class InputElement {
		 ...
		 * @return the next nested object or <code>null</code>.
		 */
		public/*<T>*/ Object/*{T}*/ get(String localName, String uri) throws XMLStreamException {
			if(uri == null)
		 ...
		 * @return the next nested object or <code>null</code>.
		 */
		public/*<T>*/ Object/*{T}*/ get(String name, Class/*<T>*/ cls) throws XMLStreamException {
			if(!hasNext()// Asserts isReaderAtNext == true
					|| !_reader.getLocalName().equals(name))
				return null;
			final Object ref = readReference();
		 ...
		 * @return the next nested object or <code>null</code>.
		 */
		public/*<T>*/ Object/*{T}*/ get(String localName, String uri, Class/*<T>*/ cls) throws XMLStreamException {
			if(uri == null)
		 ...
		 *         the default value if the attribute is not found.
		 */
		public/*<T>*/ Object/*{T}*/ getAttribute(String name, Object/*{T}*/ defaultValue) throws XMLStreamException {
			final CharArray value = getAttribute(name);
			if(value == null)
				return defaultValue;
	...
	public static final class OutputElement {
		 ...
		 */
		public/*<T>*/ void add(Object/*{T}*/ obj, String name, Class/*<T>*/ cls) throws XMLStreamException {
			if(obj == null)
				return;
			// Writes start element.
			_writer.writeStartElement(toCsq(name));
		 ...
		 * @param cls the class identifying the format of the specified object.
		 */
		public/*<T>*/ void add(Object/*{T}*/ obj, String localName, String uri, Class/*<T>*/ cls)
		...
		public void setAttribute(String name, Object value) throws XMLStreamException {
			...
			final TextFormat format = TextFormat.getInstance(type);
			setAttribute(name, (TextBuilder) format.format(value, _tmpTextBuilder.clear()));
		}
		// Sets XML binding.
		void setBinding(XMLBinding xmlBinding) {
			_binding = xmlBinding;
