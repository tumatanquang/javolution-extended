...
public abstract class TextFormat/*<T>*/ {
	...
	public static/*<T>*/ TextFormat/*<T>*/ getDefault(Class/*<? extends T>*/ forClass) {
		...
		final LocalReference localReference = (LocalReference) Reflection.getInstance().getField(forClass,
				LocalReference.class, true);
	 ...
	 */
	public abstract Appendable format(Object/*{T}*/ obj, Appendable dest) throws IOException;
	/**
	...
	private static class Predefined {
		...
		//
		private static final TextFormat OBJECT_FORMAT = new TextFormat(Object.class) {
		...
		private static final TextFormat STRING_FORMAT = new TextFormat(String.class) {
			public Appendable format(Object obj, Appendable dest) throws IOException {
				return dest.append(j2meToCharSeq(obj));
			}
			public Object parse(CharSequence csq, Cursor cursor) {
				final String str = csq.subSequence(cursor.getIndex(), csq.length()).toString();
				cursor.setIndex(csq.length());
				return str;
			}
		};
		private static final TextFormat BOOLEAN_FORMAT = new TextFormat(Boolean.class) {
			public Appendable format(Object obj, Appendable dest) throws IOException {
		...
		private static final TextFormat CHARACTER_FORMAT = new TextFormat(Character.class) {
			public Appendable format(Object obj, Appendable dest) throws IOException {
		...
		private static final TextFormat BYTE_FORMAT = new TextFormat(Byte.class) {
			public Appendable format(Object obj, Appendable dest) throws IOException {
		...
		private static final TextFormat SHORT_FORMAT = new TextFormat(Short.class) {
			public Appendable format(Object obj, Appendable dest) throws IOException {
		...
		private static final TextFormat INTEGER_FORMAT = new TextFormat(Integer.class) {
			public Appendable format(Object obj, Appendable dest) throws IOException {
		...
		private static final TextFormat LONG_FORMAT = new TextFormat(Long.class) {
			public Appendable format(Object obj, Appendable dest) throws IOException {
		...
		private static final TextFormat FLOAT_FORMAT = new TextFormat(Float.class) {
			public Appendable format(Object obj, Appendable dest) throws IOException {
		...
		private static final TextFormat DOUBLE_FORMAT = new TextFormat(Double.class) {
			public Appendable format(Object obj, Appendable dest) throws IOException {
		...
		private static final TextFormat CLASS_FORMAT = new TextFormat(Class.class) {
			public Appendable format(Object obj, Appendable dest) throws IOException {
				return dest.append(j2meToCharSeq(((Class) obj).getName()));
			}
			public Object parse(CharSequence csq, Cursor cursor) {
				final CharSequence className = cursor.nextToken(csq, CharSet.WHITESPACES);
				if(className == null)
		...
		private static final TextFormat TEXT_FORMAT = new TextFormat(Text.class) {
			public Appendable format(Object obj, Appendable dest) throws IOException {
				return dest.append((Text) obj);
			}
			public Object parse(CharSequence csq, Cursor cursor) {
				final CharSequence subCsq = csq.subSequence(cursor.getIndex(), csq.length());
