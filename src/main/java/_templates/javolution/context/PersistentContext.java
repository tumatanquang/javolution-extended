...
public class PersistentContext extends Context {
	...
	protected void enterAction() {
		throw new _templates.java.lang.UnsupportedOperationException("Cannot enter persistent context (already in)");
	}
	/**
	 * Throws <code>UnsupportedOperationException</code> persistent context
	 * are global to all threads (singleton).
	...
	protected void exitAction() {
		throw new _templates.java.lang.UnsupportedOperationException("Cannot exit persistent context (always in)");
	}
	/**
	 ...
	 */
	public static class Reference /*<T>*/ implements _templates.javolution.lang.Reference/*<T>*/ {
		/**
		 * Holds the instances.
		 */
