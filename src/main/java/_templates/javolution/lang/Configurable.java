...
public class Configurable/*<T>*/ {
	 ...
	 *         context).
	 */
	protected void notifyChange(Object/*{T}*/ oldValue, Object/*{T}*/ newValue) throws UnsupportedOperationException {}
	/**
	 ...
	 *         be modified.
	 */
	public static /*<T>*/ void configure(Configurable/*<T>*/ cfg, Object/*{T}*/ newValue) throws SecurityException {
		if(newValue == null)
			throw new IllegalArgumentException("Default value cannot be null");
		final SecurityContext policy = SecurityContext.getCurrentSecurityContext();
	...
	public static void read(InputStream inputStream) {
		try {
			final XMLObjectReader reader = XMLObjectReader.newInstance(inputStream);
